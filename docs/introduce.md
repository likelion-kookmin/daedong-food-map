...
### 김민정
정해진 기한 안에 서비스를 구현해내야 하는 해커톤임에도 팀원 모두가 열정적으로 최대한 많은 기능을 구현하려고 했던 것 같습니다.
기획했던 주요 기능의 대부분은 기간 안에 서비스에 담아내었는데, 팀원 모두가 최선을 다했기 때문에 이뤄진 결과라고 생각합니다.

웹 서비스를 처음부터 같이 고민하고, 기획하고, 설계한 것은 몇 번 되지 않기 때문에 새로운 경험을 할 수 있었습니다.
django-rest-framework와 react.js를 사용해 본 경험이 처음은 아니었지만, 프로젝트 생성부터 함께 해 본 적은 없어서 공부가 많이 되었습니다.
덕분에 스스로도 많이 성장할 수 있는 기회가 아니었나 싶습니다.

이번 프로젝트는 제가 참여한 프로젝트 중 처음으로 배포하게 된 프로젝트여서 감회가 색다릅니다.
서비스를 더욱 개선해서 재배포 하게 된다면 좋겠습니다.

이번 해커톤을 하면서 시간이나 체력적으로 힘든 부분이 많았는데 그때마다 힘낼 수 있도록 도와주신 팀장님, 팀원분들에게 감사합니다!
앞으로 좋은 기회로 다시 만날 수 있었으면 좋겠습니다.
