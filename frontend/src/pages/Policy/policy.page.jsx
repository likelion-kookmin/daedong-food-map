    ...
    <section>
      <p>
        <p class="ls2 lh6 bs5 ts4">
          <em class="emphasis">
            대동먹지도팀('https://daedong-food-map.netlify.app/'이하 '대동먹지도')
          </em>
        ...
        <p class="ls2">
          ○ 이 개인정보처리방침은
          <em class="emphasis">2021</em>년 <em class="emphasis">8</em>월 <em class="emphasis">9</em>
          부터 적용됩니다.
        </p>
        <br />
        <p class="lh6 bs4">
        ...
        <ul class="list_indent2 mgt10">
          ...
          <p class="ls2">
            회원 가입의사 확인, 회원자격 유지·관리, 서비스 부정이용 방지, 만14세 미만 아동의
            개인정보 처리 시 법정대리인의 동의여부 확인, 각종 고지·통지 목적으로 개인정보를
            처리합니다.
          </p>
        ...
        <br />
        <p class="lh6 bs4">
          <strong>제4조(정보주체와 법정대리인의 권리·의무 및 그 행사방법)</strong>
        </p>
        <p class="ls2">
          <br />
          <br />① 정보주체는 대동먹지도팀에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의
          권리를 행사할 수 있습니다.
        </p>
        <p class="sub_p">
          ② 제1항에 따른 권리 행사는대동먹지도팀에 대해 「개인정보 보호법」 시행령 제41조제1항에
          따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 대동먹지도팀은(는) 이에 대해
          지체 없이 조치하겠습니다.
        </p>
        <p class="sub_p">
        ...
        <p class="sub_p">
          ⑥ 대동먹지도팀은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구
          시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.
        </p>
        <br />
        <br />
        <p class="lh6 bs4">
          <strong>제5조(처리하는 개인정보의 항목 작성)</strong>
          <br />
          <br />① <em class="emphasis">대동먹지도팀</em>은(는) 다음의 개인정보 항목을 처리하고
          있습니다.
        </p>
        <ul class="list_indent2 mgt10">
          <li class="tt">1 홈페이지 회원가입 및 관리</li>
          <li>
            필수항목 : 이메일, 비밀번호 질문과 답, 비밀번호, 로그인ID, 이름, 서비스 이용 기록, 접속
            로그, 쿠키, 접속 IP 정보, 결제기록
          </li>
          <li>선택항목 : 휴대전화번호, 성별, 생년월일</li>
        </ul>
        <br />
        <br />
        <p class="lh6 bs4">
        ...
        <p class="ls2">
          ① 대동먹지도팀 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게
          ...
          1. 파기절차
          <br />
          대동먹지도팀 은(는) 파기 사유가 발생한 개인정보를 선정하고, 대동먹지도팀 의 개인정보
        ...
        <p class="sub_p mgt10">
          ...
          2. 접속기록의 보관 및 위변조 방지
          <br />
          개인정보처리시스템에 접속한 기록을 최소 1년 이상 보관, 관리하고 있으며,다만, 5만명 이상의
        ...
        <p class="ls2">
          <br />
          <br />① 대동먹지도팀 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를
        ...
        <p class="sub_p mgt10">
          ① <span class="colorLightBlue">대동먹지도팀</span> 은(는) 개인정보 처리에 관한 업무를
        ...
        <ul class="list_indent2 mgt10">
          ...
          <li>직책 :팀장</li>
          <li>직급 :팀장</li>
          <li>연락처 :01093754685, singun11@gmail.com, </li>
        </ul>
        <br />
        <p class="sub_p">
          ② 정보주체께서는 대동먹지도팀 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보
          보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
          문의하실 수 있습니다. 대동먹지도팀 은(는) 정보주체의 문의에 대해 지체 없이 답변 및
          처리해드릴 것입니다.
        </p>
        <p class="sub_p">
          <p class="lh6 bs4">
            <strong>
              제11조(권익침해 구제방법)<em class="emphasis"></em>
            </strong>
          </p>
          <p>
        ...
        <p class="sub_p">① 이 개인정보처리방침은 2021년 8월 9부터 적용됩니다.</p>
